...
class VideoCamera(object):
    def __init__(self, flip = False, file_type  = ".jpg", photo_string= "stream_photo"):
        ...
        # self.capture_config = self.vs.create_still_configuration(controls={"ExposureTime": 10000})
        ...
        # self.vs.configure(self.vs.create_preview_configuration({"size": (800, 600)}, transform=Transform(hflip=flip, vflip=True), controls={"AwbEnable": True, "AwbMode": controls.AwbModeEnum.Auto}))
        self.vs.start()
